...
class IotModel{
  int buttonstr,buttonstop,control,left,right,fast,fast2,speed,time;
  ...
  IotModel(
    ...
    this.time,this.fast,this.control,this.leftpn,this.rightpn,this.fast2,this.speed,this.timepn
  );
